        ...
        children: [
          ...
          InkWell(
            ...
            child: buildAnimatedContainer(
                ...
                hover: isGraphic,
                description:
                    "Innovative self-taught UI designer crafting intuitive and visually striking mobile app interfaces. Combining creativity with user-centric design principles to deliver engaging, seamless user experiences across platforms."),
          ),
          Constants.sizedBox(height: 24.0),
          // InkWell(
          //   onTap: () {},
...
//   }
  ...
  Container buildAnimatedContainer({
    String title = '',
    String asset = '',
    String? description,
    bool hover = true,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            description ??
                "Experienced Flutter developer offering custom cross-platform mobile app solutions. Specializing in creating high-performance, visually appealing iOS and Android apps with efficient, maintainable code",
            style: AppTextStyles.normalStyle(fontSize: 14.0),
            textAlign: TextAlign.center,
          ),
          Constants.sizedBox(height: 20.0),
